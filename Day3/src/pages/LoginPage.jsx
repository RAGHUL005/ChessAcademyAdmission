  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      if (formData.role === 'user') {
        if (formData.username === 'user' && formData.password === 'userpassword') {
          console.log('Login successful as User:', formData);
          navigate('/userpage', { state: { user: formData }, replace: true });
        } else {
          setErrors({
            ...errors,
        ...
        if (formData.username === 'admin' && formData.password === 'adminpassword') {
          ...
          navigate('/admin', { state: { user: formData }, replace: true });
        } else {
          setErrors({
            ...errors,
